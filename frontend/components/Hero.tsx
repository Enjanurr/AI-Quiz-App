...
<h1 className="text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mt-14 leading-tight">
  AI Quiz Generator<br className="hidden sm:block" />
...
<div className="mt-32 w-full max-w-6xl text-center px-4">
  ...
  <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
    Experience effortless quiz creation from educational videos — fast, accurate, and tailored to boost retention.
  </p>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
    {[
      {
        title: "🎯 Save Time",
        description: "No need to manually create questions. Let the AI do the work in seconds.",
      },
      {
        title: "📹 Video to Quiz",
        description: "Paste a YouTube link or upload a video — quizzes are created automatically.",
      },
      {
        title: "📊 Personalized Learning",
        description: "Questions are based on key concepts to improve comprehension and memory.",
      },
      {
        title: "⚡ Fast & Easy",
        description: "Minimal clicks, clean interface — quiz generation couldn’t be simpler.",
      },
    ].map((item, index) => (
      <div
        key={index}
...
{/* How It Works */}
<div id="how-it-works" className="mt-32 w-full max-w-6xl px-4 text-center">
  <h2 className="text-4xl md:text-5xl font-bold text-slate-100 mb-6">
    How It Works
  </h2>
  <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
...
<div className="mt-24 bg-gradient-to-r from-sky-500/10 to-yellow-500/10 border border-sky-500/20 rounded-2xl p-10 text-center max-w-6xl mx-auto">
  ...
  <p className="text-slate-400 mb-8 max-w-2xl mx-auto">
    Upload any video and let our AI handle the rest — saving you hours of manual work while helping learners retain information better.
  </p>
